    ...
    <section className="headerProfile">
      {editName ? (
        <Fragment>
          ...
          <Input className="headerProfileInput" type="text" placeholder={firstName} action={(e) => setFirstName(e.target.value)} />
          <Input className="headerProfileInput" type="text" placeholder={lastName} action={(e) => setLastName(e.target.value)} />
          <br />
          <Button className="buttonEdited" text="Save" action={() => changeUserProfile()} />
          <Button className="buttonEdited" text="Cancel" action={() => setEditName(false)} />
        </Fragment>
      ) : (
        <Fragment>
          <h1>
