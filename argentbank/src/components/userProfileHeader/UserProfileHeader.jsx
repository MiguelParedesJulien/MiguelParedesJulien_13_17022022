    ...
    <section className="headerProfile">
      {editName ? (
        <Fragment>
          ...
          <input placeholder={firstName} type="text" className="headerProfileInput" onChange={(e) => setFirstName(e.target.value)} />
          <input placeholder={lastName} type="text" className="headerProfileInput" onChange={(e) => setLastName(e.target.value)} />
          <br />
          <Button className="editButton" text="Confirm" action={() => changeUserProfile()} />
          <Button className="editButton" text="Cancel" action={() => setEditName(false)} />
        </Fragment>
      ) : (
        <Fragment>
          <h1>
          ...
          <Button className="editButton" text="Edit Name" action={() => setEditName(true)} />
        </Fragment>
      )}
    </section>
  );
